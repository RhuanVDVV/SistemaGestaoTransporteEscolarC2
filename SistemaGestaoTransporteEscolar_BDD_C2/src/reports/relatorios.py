...
class Relatorio:
    def __init__(self):
        ...
        with open("./src/sql/relatorio_escolas_qtd_alunos.sql") as f:
        ...
        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("./src/sql/relatorio_escolas.sql") as f:
        ...
        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("./src/sql/relatorio_peruas.sql") as f:
            self.query_relatorio_peruas = f.read()

        with open("./src/sql/relatorio_responsaveis.sql") as f:
